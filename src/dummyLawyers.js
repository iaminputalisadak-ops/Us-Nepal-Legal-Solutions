export const DUMMY_LAWYERS = [
  {
    ...
    focus: "Energy, Hydropower, Aviation & FDI",
    image_url:
    ...
    experience:
      "15+ years across corporate advisory, project finance, and dispute resolution including tribunal and appellate matters.",
    specializations:
      "Foreign Direct Investment (FDI), Project Finance, Aviation Law, Corporate Compliance, Arbitration",
    bar_associations: "Nepal Bar Association; Supreme Court Bar Association",
  },
  {
    id: "dummy-2",
    name: "Kedar Pyakurel",
    role: "Principal Associate",
    focus: "Civil, Corporate & Writ Litigation",
    image_url:
    ...
    experience:
      "10+ years in trial and appellate litigation, injunctions, writs, and regulatory challenges.",
    specializations:
      "Writ Litigation, Corporate Litigation, Commercial Disputes, Employment Matters",
    bar_associations: "Nepal Bar Association",
  },
  {
    id: "dummy-3",
    name: "Muktinath Acharya",
    role: "Senior Associate",
    focus: "Property Law, Civil Law & Family Law",
    image_url:
    ...
    experience:
      "8+ years advising on property transfers, inheritance disputes, and family settlements.",
    specializations:
      "Property Transactions, Inheritance, Family Disputes, Mediation",
    bar_associations: "Nepal Bar Association",
  },
  {
    id: "dummy-4",
    name: "Sudeep Pradhan",
    role: "Associate",
    focus: "Banking & Finance, Corporate Advisory",
    image_url:
  ...
  },
  {
    ...
    name: "Amit Kerna",
    role: "Associate",
    focus: "Commercial Contracts & Dispute Resolution",
    image_url:
